...
window.CTF_PROBLEMS = [
  ...
  },
  {
    id: "pigpen",
    title: "Pigpen Cipher",
    description: "ถอดรหัสข้อความที่ได้ด้วยหลักการของ Pigpen Cipher ทีละตัวอักษร",
    resources: [
      { label: "ภาพ Pigpen", url: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/Pigpen_cipher_key.svg/1200px-Pigpen_cipher_key.svg.png" }
    ],
    hint: "https://miro.medium.com/v2/resize:fit:1400/1*4tHgmNenIr6KT586F03CCg.jpeg",
    subproblems: [
      { number: 1, answer: "INTANIACU" },
      { number: 2, answer: "LARNGEAR" },
      { number: 3, answer: "VERYEAZYCODE" },
